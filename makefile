...
#avrdude -c avrftdi  -p attiny13 -U lfuse:w:0x7a:m -U hfuse:w:0xfb:m
HZ=9600000
...
#
# AVRDUDE_PORT=/dev/ttyUSB3 -b 9600
...
# compiler
CFLAGS= -DF_CPU=$(HZ) -I. $(INC) -g -mmcu=$(MCU) -O$(OPTLEVEL) \
